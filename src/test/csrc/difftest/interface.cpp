...
INTERFACE_L2TLB_EVENT {
  ...
  if (packet->valid) {
    ...
    packet->level = level;
    packet->pf = pf;
    packet->pteidx[0] = pteidx_0;
    packet->pteidx[1] = pteidx_1;
    packet->pteidx[2] = pteidx_2;
    packet->pteidx[3] = pteidx_3;
    packet->pteidx[4] = pteidx_4;
    packet->pteidx[5] = pteidx_5;
    packet->pteidx[6] = pteidx_6;
    packet->pteidx[7] = pteidx_7;
    packet->vsatp = vsatp;
    packet->hgatp = hgatp;
    packet->gvpn = gvpn;
